...
// Main Component
interface ManagementPmViewProps {
  currentUser: User;
  projects: Project[];
  tasks: Task[];
  teamMembers: User[];
...
type ManagementPmTab = 'create' | 'gantt' | 'reports';

const ManagementPmView: React.FC<ManagementPmViewProps> = (props) => {
  const [activeTab, setActiveTab] = useState<ManagementPmTab>('gantt');
  ...
  return (
    <div>
        <h1 className="text-2xl font-bold text-gray-900 mb-4">Management PM Portal</h1>
...
export default ManagementPmView;